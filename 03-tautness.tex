...
Then, a a subspace $\Y\subseteq \X$ is open if the characteristic map $\X_0 \to {\Omega}$ of $\Y_0 \subseteq \X_0$ can be endowed with the structure of a vf-functor $\X \to \mathbf{\Omega}$.
