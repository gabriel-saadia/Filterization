...
\begin{enumerate}
    ...
    \item[ii.]\looseness=-1 on the other, we can consider its localic reflection $\Lref{\E}$, take its space of points $\pt(\Lref{\E})$, and endow it with the canonical vf-poset structure induced by its topology.
\end{enumerate}
